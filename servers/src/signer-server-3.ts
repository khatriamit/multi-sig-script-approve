/**
 * Signer server 3: reads transaction payload, signs with SIGNER_3, writes to tx_folder/signature/signature-3.json
 * Run: npx ts-node servers/signer-server-3.ts
...
export async function main() {
  ...
  const walletKey = process.env.BACKEND_WALLET_3!
